...
const DownloadAppSection = () => {
    ...
    return (
        <div className='w-full flex justify-center items-center gap-[100px] my-[90px]  max-sm:px-[16px]' >
            ...
            <div className='flex flex-col items-start justify-start max-w-[410px] max-mdp:justify-center  '>
                ...
                <ParagraphField title={t('pTitle')} paragraph={t('pText')} className='mt-[30px]'  tClassName='max-mdp:text-center max-sm:text-[16px]' pClassName='max-mdp:text-center' />
