                ...
                <InfoDisplay className='max-w-screen-xl justify-between items-center'>
                    ...
                    </div>
                    {
                        <div className='w-full flex justify-end items-center'>
                            {[... new Array(3)].map((_, i) => <TimeTitle numText={t(`date.${i}.time`)} text={t(`date.${i}.text`)} key={i} tClassName='!text-4xl' className='!mr-[1px] ml-[24px]' />)}
                        </div>
                    }
                </InfoDisplay>
            </div>
            ...
            <SectionContainer className=' z-10'>
                ...
                <div className='w-full h-full flex justify-between items-start gap-[15px]  mt-[30px] '>
                    <div className='w-[80%]  flex flex-col items-center justify-between'>
                        <ProgressActivityCard className='' label={t('goalCard.label')} title={t('goalCard.title')} paragraph={t('goalCard.paragraph')} />
